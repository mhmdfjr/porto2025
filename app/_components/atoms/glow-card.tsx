  ...
  return (
    <motion.div
      className={cn(
        ...
        "before:bg-gradient-to-r before:from-red-500/20 before:via-orange-500/20 before:to-red-500/20",
        "before:mask-composite-subtract before:[mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)]",
        className,
      )}
      whileHover={{
        scale: 1.02,
        boxShadow: `0 0 30px ${glowColor === "red" ? "rgba(239, 68, 68, 0.3)" : "rgba(251, 146, 60, 0.3)"}`,
      }}
